...
class Robot:
    def __init__(self):
        self.config = RobotConfig(
            xml_path=get_asset_path('mujoco/SundayA1_full_2dof_arm_loco/robot.xml'),
    ...
    def get_params(self):
        ...
        right_foot_pos = self.robot.collision_data.oMg[1].translation.copy()
    ...
    def ik(self,
       ...
       step: float = 0.005) -> np.ndarray:
        ...
        left_geom_name = "left_foot0120_0"
        right_geom_name = "right_foot0120_0"
    ...
    def visualize(self):
        visualizer = ViserVisualizer(get_asset_path('urdf/SundayA1_full_2dof_arm/robot.urdf'))
        running = False
